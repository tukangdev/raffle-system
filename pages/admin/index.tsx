...
const Admin = (
	...
	const { isLoading: isLoadingCreate, mutate: create } = useCreateName()
	const { isLoading: isLoadingRemove, mutate: remove } = useDeleteName()
	const {
							...
							<div className="w-full lg:w-1/2 lg:pl-2">
								...
								<div className="flex flex-col mt-6">
									...
									<Button
										onClick={e => {
											e.preventDefault()
											handleFireBaseUpload(Settings.cardLogoImage, cardLogoFile)
										}}
										leftIcon={
											<svg
												className="h-5 w-5 float-left mr-2"
